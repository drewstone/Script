...
Contract.prototype.addPatient = function(owner, patient) {
  this.contract.add_patient.sendTransaction(patient._id, patient._name, patient._dob,
    patient._city, patient._state, patient._zip, {from: owner}).then(function(tx_id) {
      return tx_id;
  });
}
